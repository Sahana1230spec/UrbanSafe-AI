...
@st.cache_data
def load_data():
    """Load and prepare the collision data"""
    try:
        ...
        collisions = collisions.fillna(collisions.mode().iloc[0])
        return collisions
    except FileNotFoundError:
        st.error("Data files not found! Please ensure CSV files are in data/raw/ folder")
        return None
